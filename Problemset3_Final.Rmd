...
Descriptive statistics of the variables are shown in Figure 1.
...
Finally, the Hierarchical clustering has some limitations such as sensitivity to noise and outliers, once the grouping is made by, it can never undo, and for large data sets, it has a high computational cost. 
