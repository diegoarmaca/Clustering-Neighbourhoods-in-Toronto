...
group1_grob <- grid.arrange(tableGrob(group1, theme = tt1, rows = NULL), ncol = 1, nrow = 1, bottom = "Table x: Summary table of Group 1")

group2_grob <- grid.arrange(tableGrob(group2, theme = tt1, rows = NULL), ncol = 1, nrow = 1, bottom = "Table x: Summary table of Group 2")
```
```{r echo=FALSE, include=TRUE, message=FALSE, fig.height = 3, fig.width = 9, warning=FALSE, fig.align='center'}


 grid.arrange(arrangeGrob(group1_grob,  ncol=1, nrow=1, name = "title"), arrangeGrob(group2_grob, ncol=1, nrow=1), heights=c(4,1), widths=c(1,1))
